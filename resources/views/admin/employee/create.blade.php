    ...
    <div class="container">
        ...
        <div class="card">
            <div class="card-header">
                <a href="{{ route('admin.employee-manage.create') }}" class="btn btn-primary"><i class="las la-sync"></i></a>
                <a href="{{ route('admin.employee-manage.index') }}" class="btn btn-primary"><i class="las la-list-ul"></i></a>
            </div>
            <div class="card-body">
                        ...
                        <div class="col-xs-12">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input maxlength="100" type="text" name="fname" required="required"
                                        class="form-control" placeholder="Enter First Name" />
                                </div>
                                <div class="form-group">
                                    <label class="control-label">Last Name</label>
                                    <input maxlength="100" type="text" name="lname" required="required"
                                        class="form-control" placeholder="Enter Last Name" />
                                </div>
                                <div class="form-group">
                                    <label class="control-label">Employee Email</label>
                                    <input maxlength="100" type="email" name="email" required="required"
                                        class="form-control" placeholder="Enter employee email" />
                                </div>
                                <div class="form-group">
                                    <label class="control-label">Employee Password</label>
                                    <input maxlength="100" type="password" name="password" required="required"
                                        class="form-control" placeholder="Enter employee password" />
                                </div>
                                <div class="form-group">
                        ...
                        <div class="col-xs-12">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input maxlength="200" type="date" name="dob" required="required"
                                        class="form-control" placeholder="Enter employee's dob" />
                                </div>
                                <div class="form-group">
                        ...
                        <div class="col-xs-12">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input maxlength="100" type="date" name="leave_date" class="form-control"
                    ...
                    <div class="row setup-content" id="step-4">
                        <div class="col-xs-12">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label class="control-label">Enter job description</label>
                                    <textarea name="notes" cols="30" rows="4" class="form-control" placeholder="Enter job Notes"></textarea>
                                </div>
                                <button class="btn btn-primary nextBtn btn-lg pull-right" type="button">Next</button>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-6">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input maxlength="100" type="text" name="phone1" required="required"
                                        class="form-control" placeholder="Enter phone 1" />
                                </div>
                                <div class="form-group">
                                    <label class="control-label">Employee phone Number 2</label>
                                    <input maxlength="100" type="text" name="phone2" required="required"
                                        class="form-control" placeholder="Enter phone 2" />
                                </div>
                                <div class="form-group">
                                    <label class="control-label">Employee Email 2</label>
                                    <input maxlength="100" type="email" name="email2" required="required"
                                        class="form-control" placeholder="Enter employee email 2" />
                                </div>
                                <div class="form-group">
                                    <label class="control-label">Employee Address</label>
                                    <input maxlength="100" type="text" name="address" required="required"
                                        class="form-control" placeholder="Enter employee address" />
                                </div>
                                <div class="form-group">
                                    <label class="control-label">Employee City</label>
                                    <input maxlength="100" type="text" name="city" required="required"
                                        class="form-control" placeholder="Enter Employee city" />
                                </div>
                                <div class="form-group">
                                    <label class="control-label">Employee Zip</label>
                                    <input maxlength="100" type="text" name="zip" required="required"
                                        class="form-control" placeholder="Enter Employee zip" />
                                </div>
                        ...
                        <div class="col-xs-6">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input maxlength="100" type="text" name="rel_phone" required="required"
                                        class="form-control" placeholder="Enter Relative's Phone " />
                                </div>
                                <div class="form-group">
                                    <label class="control-label">Employee Address</label>
                                    <input maxlength="100" type="text" name="rel_address" required="required"
                                        class="form-control" placeholder="Enter Employee Role" />
                                </div>

                                <div class="form-group">
                                    <label class="control-label">Employee Relative's City</label>
                                    <input maxlength="100" type="text" name="rel_city" required="required"
                                        class="form-control" placeholder="Enter Employee Role" />
                                </div>
